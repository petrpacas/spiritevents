            ...
            >
              ...
              >
                <input
                  ...
                  type="text"
                  name="name"
                  className="w-full rounded-lg border-stone-300 py-2 text-lg placeholder-stone-400 shadow-sm transition-shadow hover:shadow-md active:shadow sm:py-4 dark:bg-stone-800 dark:placeholder-stone-500"
                />
                <input
                  required
                  placeholder="Email"
