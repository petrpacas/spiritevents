...
export const EventListCard: FC<Props> = ({
  ...
  return (
    <Link
      to={`/events/${id}`}
      className="grid gap-2 border-y border-amber-600 bg-white p-4 hover:shadow-md active:shadow max-sm:-mx-4 max-sm:py-2 sm:flex sm:items-center sm:justify-between sm:gap-4 sm:rounded-lg sm:border-x"
    >
